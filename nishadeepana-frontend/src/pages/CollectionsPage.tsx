                                ...
                                <div className="flex-1 overflow-y-auto p-4">
                                    {hasActiveFilters && (
                                        <button
                                            ...
                                            className="text-xs text-red-500 flex items-center gap-1 mb-4"
                                        >
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="space-y-1">
                                            <button onClick={() => { setFilter('category', 'all'); setShowFilters(false); }} className={filterBtnCls(selectedCategory === 'all')}>All Sarees</button>
                                            {categories.map(cat => (
                                                <button key={cat} onClick={() => { setFilter('category', cat); setShowFilters(false); }} className={filterBtnCls(selectedCategory === cat)}>{cat}</button>
                                            ))}
                                        </div>
                                    </div>
                                    {/* Price */}
                                    <div className="mb-4">
                                        ...
                                        <div className="space-y-1">
                                            <button onClick={() => { setFilter('price', 'all'); setShowFilters(false); }} className={filterBtnCls(priceRange === 'all')}>All Prices</button>
                                            {priceRanges.map((range, idx) => (
                                                <button key={idx} onClick={() => { setFilter('price', String(idx)); setShowFilters(false); }} className={filterBtnCls(priceRange === String(idx))}>{range.label}</button>
                                            ))}
                                        </div>
                                    </div>
                                </div>
